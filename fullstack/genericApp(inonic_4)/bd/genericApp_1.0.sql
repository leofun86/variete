...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-04-2020 a las 01:34:52
...
('user5770', 'Leandro', 'Funes', 'contra2', 1);
...
CREATE TABLE `operacion` (
  ...
  `Fecha` date NOT NULL,
  `Hora` datetime NOT NULL,
  `Estado` varchar(50) NOT NULL DEFAULT 'Inicio de evento',
...
('user2532', 'Sebastian', 'Iglesias', '3367A8A67768388', 1),
('user5770', 'Lisandro', 'Farola', 'AFC64B3068AF6', 0),
('user5771', 'Paula', 'Paulox', NULL, 1),
('user8987', 'Ana', 'Moral', NULL, 1);
